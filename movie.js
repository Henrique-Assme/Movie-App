...
function editReview(id, review, user){
    ...
    element.innerHTML = `
        <p><strong">Review :</strong>
            <input class="edit-input" type="text" id="${reviewInputId}" value="${review}">
        </p>
        <p><strong>User: </strong>
            <input class="edit-input" type="text" id="${userInputId}" value="${user}">
        </p>
...
function saveReview(reviewInputId, userInputId, id=""){
    ...
    if(id){
        fetch(APILINK + id, {
            method: 'put',
            headers: {
                'Acept': 'application/json, text/plan, */*',
